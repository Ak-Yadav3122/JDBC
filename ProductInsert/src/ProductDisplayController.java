...
public class ProductDisplayController {
    public static void main(String[] args) {
        ...
        try {
            ...
            Statement statement = connection.createStatement(); // Statement is an interface which are used to execute the querry.
                                                                

            // Step:4 Execute Query
            String displayProductQuery = "select * from new_table";

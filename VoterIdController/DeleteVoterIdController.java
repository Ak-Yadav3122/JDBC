...
public class DeleteVoterIdController {
		...
		// Step:1 Load/REGISTER the driver
		 try {
			 ...
			 String deleteVoterIdQuery = "delete from Voterid where id=231";
			 
			 //This method will return 0 or 1 when given id is not present in the table
			 
			 int a = statement.executeUpdate(deleteVoterIdQuery);  // it return the value  i.e; 0 or 1 so we use int 
